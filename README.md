...
- Run tests<br/>
  ...
  <b>ng test</b><br/>
  by default ng tests runs all the tests in \*.spec.ts files. Tests are executed after build using karma.<br/>

- Run tests for a single build<br/>

  <b>ng test --watch false</b><br/>

- Run tests with code coverage<br>

  <b>ng test --code-coverage</b><br/>
  the generated report is put in a folder called /coverage. Report folder path can be changed in karma.conf.js<br/>
